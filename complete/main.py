...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.buttonConnServer.setGeometry(QtCore.QRect(300, 250, 151, 41))
        font = QtGui.QFont()
        ...
        self.inputAddress = QtWidgets.QLineEdit(self.pageConnect)
        self.inputAddress.setGeometry(QtCore.QRect(230, 200, 301, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.inputAddress.setFont(font)
        self.inputAddress.setAlignment(QtCore.Qt.AlignCenter)
    ...
    def connect_server(self):
        server_address = self.inputAddress.text()
        self.session_manager.initialize_server(server_address)
        self.log_manager.initialize_server(server_address)
        self.archive_manager.initialize_server(server_address)
        self.message_manager.initialize_server(server_address)
        self.login_form.initialize_server(server_address)
        self.signup_form.initialize_server(server_address)
        self.reset_form.initialize_server(server_address)
        self.client.initialize_server(server_address)
        if self.session_manager.check_database_accessibility():
            self.session_manager.initialize_tables_if_not_exists()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.inputAddress.setPlaceholderText(
            _translate("MainWindow", "Enter the Server IP Address")
        )
